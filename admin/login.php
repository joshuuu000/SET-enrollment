...
<title>St. Elizabeth Global Skills Institute Inc.</title>
...
body {
  background: url(../img/login_bg.jpg) repeat center center fixed ;
      ...
      <section class="login-form"> <? echo check_message(); ?>;
        <form method="post" action="" role="login">
          <!-- <img src="http://i.imgur.com/RcmcLv4.png" class="img-responsive" alt="" /> -->
           <img src="../img/Set_logo.jpg" height="25px" class="img-responsive" alt="" />
