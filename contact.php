 ...
 School Location
           ...
           <script type="text/javascript">
            ...
            <div class="col-md-4">
                ...
                <br>Km 131, Maharlika Highway Esguerra Dist. Talavera, Nueva Ecija, Philippines<br>
                </p>
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: 0967-815-0446</p>
                <p><i class="fa fa-envelope-o"></i> 
                    <abbr title="Email">Email</abbr>: <a href="mailto:name@example.com">St.Elizabethtalavera@gmail.com</a>
                </p>
