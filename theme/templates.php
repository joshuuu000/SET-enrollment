...
<title><?php echo $title; ?> | St. Elizabeth Global Skills Institute Inc.</title>
...
<nav class="navbar navbar-TOPsm navbar-fixed-top col-md-10 col-md-offset-1" role="navigation">
  <div class="container">
    <div class="navbar-header">
          <h5 class="navbar-menu p" >St. Elizabeth Global Skills Institute Inc.</h5>
   ...
   <div class="col-md-4">
    <div class="row "> 
     <p > 
        ...
        <h1 align="center" >St. Elizabeth Global Skills Institute Inc.</h1>
        </a>
    </p>
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="panel panel-default">
                  <div class="panel-heading" style="background-color:#002B7F;color:#fff;">
                  <b><?php   
...
?>
            ...
            <footer class="panel-footer" style="background-color:#002B7F;color:#fff;" >
              <p align="left" >&copy; St. Elizabeth Global Skills Institute Inc.</p>
           </footer>
      </div>
