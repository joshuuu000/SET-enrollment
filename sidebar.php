...
<!-- category -->
 <div class="panel panel-default"> 
    ...
    <div class="list-group">
     <div class="well well-sm " style="background-color:#002B7F;color:#fff;"><b> Courses </b> </div>
        <ul >
        <?php 
...
?>
 <div class="panel panel-default">
    <div class="panel-body">
        <div class="well well-sm"  style="background-color:#002B7F;color:#fff;"><b >  Login </b> </div>
            ...
            <form class="form-horizontal span6" action="login.php" method="POST">
                <div class="form-group">
                  ...
                  <div class="form-group">
                  <div class="col-md-12"> 
                    <button type="submit" id="sidebarLogin" name="sidebarLogin"  style="background-color:#002B7F;color:#fff;" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-logged-in "></span>   Login</button> 
